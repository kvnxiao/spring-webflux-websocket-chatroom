...
/**
 * Customize the Jackson ObjectMapper used by Spring.
 */
@Configuration
class JacksonConfig {

    @Bean
    fun addChatRoomSerializer(): Jackson2ObjectMapperBuilderCustomizer {
        return Jackson2ObjectMapperBuilderCustomizer {
            it.serializerByType(ChatRoom::class.java, ChatRoomSerializer())
        }
    }
}
